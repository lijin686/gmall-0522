...
public class AttrController {
    ...
    public ResponseVo<List<AttrEntity>> queryAttrByCidAndTypeOrSearchType(@PathVariable("cid") Long cid,
    ...
    public ResponseVo<List<AttrEntity>> queryAttrByGid(@PathVariable("gid") Long gid){
        List<AttrEntity> entities = this.attrService.list(new QueryWrapper<AttrEntity>().eq("group_id", gid));
